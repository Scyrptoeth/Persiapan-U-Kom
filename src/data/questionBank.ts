...
const questionSeeds: QuestionSeed[] = [
  ...
  ["tik", "Microsoft PowerPoint", "Jenis chart yang bukan chart standar PowerPoint pada soal try out adalah apa?", "Gantt Chart.", ["Column Chart", "Pie Chart", "Gantt Chart", "Line Chart"], 2, "level1", "Try out Level 1 nomor 47; chart PowerPoint."],
  ...
  ["tik", "Aplikasi Perpajakan", "Aplikasi pendukung yang bukan berada di luar DJP Online pada soal try out adalah apa?", "Web e-SPT.", ["E-SPT PPh Pasal 21/26", "E-Faktur", "Web e-SPT", "E-Registration"], 2, "level1", "Try out Level 1 nomor 49; aplikasi pendukung DJP Online."],
  ...
  ["organisasi", "KPP dan KP2KP", "KPP Pratama dengan jumlah KP2KP terbanyak pada soal try out adalah apa?", "KPP Pratama Ambon.", ["KPP Pratama Bangka", "KPP Pratama Muara Teweh", "KPP Pratama Ambon", "KPP Pratama Bukittinggi"], 2, "level1", "Try out Level 1 nomor 53; contoh wilayah kerja KP2KP."],
  ...
  ["penelaah-keberatan", "Pengurangan Sanksi", "Sanksi administrasi yang dapat diajukan pengurangan atau penghapusan pada soal try out adalah sanksi pasal apa?", "Pasal 9 ayat (2a).", ["Pasal 9 ayat (1)", "Pasal 9 ayat (2a)", "Pasal 13 ayat (1)", "Pasal 13A"], 1, "level3", "Try out Level 3 nomor 66; objek pengurangan atau penghapusan sanksi."],
  ["penelaah-keberatan", "Permohonan Kedua", "Keputusan pengurangan sanksi pertama diterima 10 Januari 2022. Kapan batas akhir permohonan kedua pada soal try out?", "2 April 2022.", ["3 April 2022", "2 April 2022", "10 April 2022", "9 April 2022"], 1, "level3", "Try out Level 3 nomor 67; batas permohonan kedua."],
  ["penelaah-keberatan", "Pihak Pemohon", "Pihak yang dapat mengajukan permohonan pengurangan atau penghapusan sanksi untuk PT pada soal try out adalah siapa?", "Direktur.", ["Direktur", "Tax manager tanpa kuasa", "Kuasa hukum tanpa surat kuasa", "Pemegang saham tanpa kewenangan"], 0, "level3", "Try out Level 3 nomor 68; pihak yang berwenang mengajukan permohonan."],
  ...
  ["penelaah-keberatan", "Sanksi Banding", "Sanksi apabila banding ditolak atau dikabulkan sebagian pada rezim materi try out adalah berapa?", "Denda 60% sesuai ketentuan yang berlaku pada materi.", ["Denda 30%", "Denda 60%", "Kenaikan 100%", "Bunga tetap Rp1.000.000"], 1, "level3", "Try out Level 3 nomor 9; sanksi banding ditolak atau dikabulkan sebagian."]
];
...
function buildExplanation(answer: string): string {
  ...
  return `Jawaban yang benar adalah ${punctuatedAnswer}`;
}
